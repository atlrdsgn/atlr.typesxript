...
export const MuxVideo = React.forwardRef<HTMLVideoElement, MuxVideoProps>(({ muxSrc, className, ...rest }, ref) => {
  ...
  return <video ref={mergeRefs([videoRef, ref])} className={className} {...rest} />;
});
